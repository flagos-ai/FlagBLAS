# Installing python3-flag-blas

After `apt install python3-flag-blas` (Debian/Ubuntu) or `dnf install python3-flag-blas` (Fedora),
...
FlagBLAS needs PyTorch (GPU build) at runtime:
