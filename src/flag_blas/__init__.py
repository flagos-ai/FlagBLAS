...
def enable(
    ...
    """Register all FlagBLAS ops except those explicitly excluded.
    ...
    Args:
        ...
        record: Whether to enable FlagBLAS logging.
...
def only_enable(
    ...
    """Register only the specified FlagBLAS ops and skip the rest.
